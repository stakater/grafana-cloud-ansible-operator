# Support Makefile for both linux and mac
UNAME_S := $(shell uname -s)
SED := sed
ifeq ($(UNAME_S),Darwin)
    ifeq (, $(shell which gsed))
        $(info "gsed not found. Installing gnu-sed...")
...
# stakater.com/grafana-cloud-ansible-operator-bundle:$VERSION and stakater.com/grafana-cloud-ansible-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/stakater/grafana-cloud-ansible-operator
